...
public class PlayerInputHandler : InputHandler
{
    ...
    public void ReloadActions()
    {
        ...
        inputActionsDictionary = new Dictionary<string, InputAction>();
    ...
    public bool GetButtonReleased(string actionName)
    {
        if (!enabled) return false;
        InputAction inputAction;
        ...
        return inputActionsDictionary[actionName].ReadValue<float>() <= InputSystem.settings.defaultButtonPressPoint && inputActionsDictionary[actionName].triggered;
